...
<p align="center">
  <img src="README 이미지 URL 또는 앱 로고 이미지 경로" alt="Sniff Logo" width="300">
</p>
...
이번 프로젝트를 통해 단순히 향수 정보를 보여주는 앱이 아니라, 사용자의 취향을 분석하고 추천과 기록으로 이어지는 흐름을 설계하는 경험을 할 수 있었습니다.

특히 향수 데이터 확보, API 데이터 한글화, Firebase 인증 및 데이터 동기화, 민감 정보 관리 등 실제 서비스 개발 과정에서 발생할 수 있는 문제를 직접 해결하며 iOS 앱 개발 전반의 흐름을 경험했습니다.

앞으로는 유저 피드백을 기반으로 리뷰, 커뮤니티, 추천 기록 히스토리 기능을 추가하여 사용자가 자신의 향수 취향을 더 깊이 탐색할 수 있는 서비스로 발전시키고자 합니다.
